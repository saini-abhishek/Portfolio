...
const FeaturedProject = ({
  ...
  return (
    <article className="w-full flex items-center justify-between rounded-3xl border border-solid dark:text-light border-dark dark:border-light bg-light dark:bg-dark shadow-2xl p-12">
      <Link
      ...
      <div className="w-1/2 flex flex-col items-start justify-between pl-6">
        ...
        <div className="mt-2 flex items-center">
          ...
          <Link
            href={link}
            target="_blank"
            className="ml-4 rounded-lg bg-dark dark:bg-light text-light dark:text-dark p-2 p-x6 text-lg font-semibold"
          >
            Visit Project
          </Link>
        </div>
...
const Project = ({
  ...
  return (
    <article className="w-full flex flex-col items-center dark:text-light justify-center rounded-2xl border border-solid border-dark dark:border-light bg-light dark:bg-dark p-6 relative">
      <Link
...
const projects = () => {
  ...
  return (
    <main className="flex w-full flex-col items-center justify-center">
      <h1
        className={`inline-block w-full text-dark dark:text-light font-bold capitalize text-4xl text-center my-16`}
      >
